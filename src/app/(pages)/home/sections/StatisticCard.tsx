const StatisticCard = ({ title, value }: { title: string; value: string }) => {
  return (
    <div className="flex flex-col items-center w-[180px] md:w-[220px] lg:w-[260px] h-auto p-[20px] bg-[#F2F4F6] border-white border-[2px] rounded-[24px] shadow-[0px_0px_10px_0px_#00000040]">
