...
const SearchOpportunity = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center mb-[120px] sm:px-0 px-2">
      <h1 className="text-primary text-[35px] md:text-[40px] lg:text-[50px] text-center font-[600] tracking-[0.5px] leading-normal font-clashBold">
      ...
      <div className="relative flex items-center">
        ...
        <form action="POST">
          <input
            type="text"
            className="mt-[60px] w-[350px] sm:w-[600px] md:w-[800px] bg-[#CEE0FE] rounded-[30px] py-[10px] pl-[40px] pr-[20px] placeholder:text-primary/50 text-[16px] font-[500]"
